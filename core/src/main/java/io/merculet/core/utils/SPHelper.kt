 ...
 * @description
 */
class SPHelper private constructor(private val context: Context? = App.instance) {
    ...
    companion object {
        ...
        const val TRACKING_DEVICE_ID = "device_id"         //device_id

        fun create(context: Context = App.instance): SPHelper {
