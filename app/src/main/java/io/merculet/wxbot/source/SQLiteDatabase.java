...
//        SQLiteStatement sQLiteStatement;
//        try {
//            StringBuilder stringBuilder = new StringBuilder(ErrorCode.DOWNLOAD_HAS_LOCAL_TBS_ERROR);
...
//            if (r2.moveToNext() == false) goto L_0x005a;
//     */
...
//        r2 = r5.mLock;
//        monitor-enter(r2);
//        r3 = r5.mConnectionPoolLocked;	 Catch:{ all -> 0x0057 }
...
//        return r0;
//    L_0x000f:
//        r3 = r5.mHasAttachedDbsLocked;	 Catch:{ all -> 0x0057 }
//        if (r3 != 0) goto L_0x0025;
//    L_0x0013:
//        r0 = new android.util.Pair;	 Catch:{ all -> 0x0057 }
//        r3 = "main";
//        r4 = r5.mConfigurationLocked;	 Catch:{ all -> 0x0057 }
...
//        goto L_0x000e;
//    L_0x0025:
//        r5.acquireReference();	 Catch:{ all -> 0x0057 }
//        monitor-exit(r2);	 Catch:{ all -> 0x0057 }
//        r2 = "pragma database_list;";
//        r3 = 0;
//        r2 = r5.rawQuery(r2, r3);	 Catch:{ all -> 0x0064 }
//    L_0x0031:
