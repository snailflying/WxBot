            ...
            override fun afterHookedMethod(param: MethodHookParam) {
                ...
                if (!TextUtils.isEmpty(tableName) && tableName == "message") {
                    ...
                    if (isSend == 0 && status == 3 && type == 1) { // type 1.文本 3.图片 48.位置
                        ...
                        LogUtil.log("AddFriendHooker talker: $talker -- content: $content")
                    }
                }
...
//                        val luckyMoneyRequest = newInstance(Classes.AddFriendHooker, 4, talker, ticket, 30, 0) // 即com.tencent.mm.pluginsdk.model.m中构造public m(String str, String str2, int i, byte b)
                        LogUtil.log("luckyMoneyRequest: $luckyMoneyRequest")
